...
Config.Notify = 'ox_lib' --'ox_lib' or for qbcore 'qb-notify'
Config.Progressbar = 'ox_lib' -- 'ox_lib' or for qbcore 'progressbar'
Config.Fade = false -- Fully Fades When You Are Changing Floors
Config.SecondalFade = true -- Only Fades When You Are Teleporting

Config.Target = false -- Uses qb-target or ox_target auto start
...
Config.UI = {
    Interaction = {
        Type = 'Modern-Draw-Text',
        Prompt = '~INPUT_PICKUP~ Elevator'
    }
}
...
Config.Elevators = {
    ["Mazebank Elevator"] = {
        ...
        Floors = {
            ...
            [2] = {
                Label = "Bottom Floor",
                description = '',
                Coord = vector3(-84.1352, -821.4475, 36.029),
                Poly = {
                    minZ = 35.02825,
                    maxZ = 38.4517,
                    Length = 8.5,
    ...
    ["Emlakçı 2"] = {
        ...
        Floors = {
            [1] = {
                Label = "Zemin Kat",
                description = 'Zemin kata gider',
                Coord = vector3(-71.06, -801.01, 44.23),
                Poly = {
                    minZ = 205.9197,
                    maxZ = 208.2022,
                    Length = 0.2,
                ...
                Spawn = {
                    PlayerSpawn = vector3(-71.06, -801.01, 44.23),
                    PlayerHeading = 336.54,
                },
            },
            [2] = {
                Label = "İkinci",
                description = 'İkinci Kata Gider',
                Coord = vector3(-1577.62, -563.62, 108.52),
                Poly = {
                    minZ = 168.8488,
                    maxZ = 169.1849,
                    Length = 0.2,
                ...
                Spawn = {
                    PlayerSpawn = vector3(-1577.62, -563.62, 108.52),
                    PlayerHeading = 336.54,
                },
            },
        },
    ...
    ["Go KartPisti"] = {
        ...
        Floors = {
            [1] = {
                Label = "Zemin Kat",
                description = 'Zemin kata gider',
                Coord = vector3(-282.40, -2031.51, 30.15),
                Poly = {
                    minZ = 205.9197,
                    maxZ = 208.2022,
                    Length = 0.2,
                ...
                Spawn = {
                    PlayerSpawn = vector3(-282.40, -2031.51, 30.15),
                    PlayerHeading = 293.16,
                },
            },
            [2] = {
                Label = "İkinci",
                description = 'İkinci Kata Gider',
                Coord = vector3(5629.93, 328.93, 20.22),
                Poly = {
                    minZ = 168.8488,
                    maxZ = 169.1849,
                    Length = 0.2,
                ...
                Spawn = {
                    PlayerSpawn = vector3(5629.93, 328.93, 20.22),
                    PlayerHeading = 6.04,
                },
            },
        }
